...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.a2c6abd85452578756e2e3c6212fefe5ddedeadb5e8fc761457c7d6d59aaccaa.js',function(){input.required=false;search();});}
